...
import { isPrimaryButton, isAuxiliaryButton } from "diagram-js/lib/util/Mouse";
...
export default function InteractionEvents(eventBus, elementRegistry, styles) {
  ...
  function registerEvent(node, event, localEvent, ignoredFilter) {
    var handler = (handlers[localEvent] = function (event) {
      // console.log('fire', localEvent, event);
    ...
    // console.log('registerEvent', node, event, localEvent, handler);

    handler.$delegate = domDelegate.bind(
      node,
      ELEMENT_SELECTOR,
      event,
      handler
